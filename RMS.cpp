...
int main(){
	...
	cout<<"|*---------------------------MENU-----------------------------*|"<<endl;
	cout<<endl;
	cout<<"(1)  Veg Biryani                    $2 only."<<endl;
	cout<<"(2)  Veg Palao                      $1.5 only."<<endl;
	cout<<"(3)  Chinese Rice                       $2.5 only."<<endl;
	cout<<"(4)  Cheese Burgar                     $1 only."<<endl;
